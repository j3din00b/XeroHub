...
main_menu() {
  ...
  case "$CHOICE" in
    1)
      clear && install_packages "cosmic linux-headers pacman-contrib xdg-user-dirs wayland-protocols wayland-utils lib32-wayland system76-power system-config-printer"
